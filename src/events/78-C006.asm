INCLUDE "../macros.asm"
SECTION "celebiunlock",ROM0[$100]
jp Start
db $00

TicketSprite: ; 104
	INCBIN "gfx/celebi.shiny.4bpp"
TicketPalette: ; 1604
	INCBIN "gfx/celebi.shiny.pal"

Prologue:
	INCBIN "{REGION_NAME}/payload/prologue.bin"

DataPacket: ; 164a
	INCBIN "{REGION_NAME}/payload/celebi.unlocked.mev"
	db 0,0,0 ; padding
